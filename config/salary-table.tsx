...
export function SalaryDataTable<TData, TValue>({
	columns,
	data,
	...
	return (
		<div className="rounded-lg border-[1px] py-0">
			<Modal isOpen={isModalOpen} onClose={closeModal} title="New Salary Head">
				<div className="bg-white p-0 rounded-lg  transition-transform ease-in-out form">
					<div className="mt-3  pt-2">
						<div className="flex flex-col gap-2">
							<p className="text-xs text-primary-6">New salary head</p>
							<Input
								type="text"
								placeholder="Enter new salary head"
						...
						<div className="flex flex-row justify-end items-center gap-3 font-inter">
							...
							<Button
								...
								disabled={isLoading}>
								{isLoading ? "Issuing..." : "Save salary head"}
							</Button>
						</div>
					</div>
				</div>
			...
			<div className="p-3 flex flex-row justify-between border-b-[1px] border-[#E2E4E9] bg-white items-center gap-20 max-w-full rounded-lg">
				<div className="p-3 flex flex-row justify-start items-center gap-3 w-full ">
					...
					<Button
						className="bg-primary-1 text-white   font-inter border-[1px] border-gray-300"
						onClick={openModal}>
						<IconArrowLeftRight /> New Salary Head
					</Button>
				</div>
			</div>
