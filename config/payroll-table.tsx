...
import { IconCircleCheckFilled, IconSettings } from "@tabler/icons-react";
...
export function PayrollDataTable<TData, TValue>({
	...
	return (
		<div className="rounded-lg border-[1px] py-0">
			<Modal isOpen={isModalOpen} onClose={closeModal} title="Payroll Settings">
				<div className="bg-white p-0 rounded-lg w-[600px] transition-transform ease-in-out form">
					<div className="">
						<hr className="mt-4 mb-4 text-[#9F9E9E40]" color="#9F9E9E40" />
						<div className="flex flex-col gap-2 border border-[#96BBD2] rounded-lg p-4 bg-[#ECF3F8]">
							<p className="text-sm text-primary-1">Current payday</p>
							<p className="text-sm text-primary-1 font-normal">
								<span className="text-lg font-bold">28th</span> day of every
								month{" "}
							</p>
						</div>

						<div className="flex flex-col gap-2 mt-4">
							<p className="text-xs text-primary-6">Change Pay Day</p>
							<Input
								type="text"
								placeholder="Enter New Pay Day"
						...
						<div className="flex flex-row justify-end items-center gap-3 font-inter">
							...
							<Button
								...
								disabled={isLoading}>
								{isLoading ? "Adding Staff..." : "Save new payday"}
							</Button>
						</div>
					</div>
				</div>
			...
			<div
				className="bg-white flex flex-row border-b-[1px] border-[#E2E4E9] justify-end items-center p-3"
				style={{
				...
				<div className="flex flex-row justify-end items-center gap-3 font-inter">
					<Button
						className="bg-white text-gray-500 font-inter border border-gray-500 "
						onClick={openModal}>
						<IconSettings /> Payroll Settings
					</Button>
				</div>
			</div>

			<div className="flex flex-row justify-between items-center gap-3 mt-3 p-3 bg-white">
				<h2>Recently Saved</h2>
				<Link href="#">
					<p className="text-primary-1 text-sm font-inter font-medium">
						See all saved payrolls
					</p>
				</Link>
			</div>

			<div className="w-full mx-auto flex flex-col gap-3 px-3 bg-white">
				<div className="flex flex-row justify-between items-center gap-3 p-3 bg-white border-[1px] border-[#E9EAEA] rounded-lg  mx-10">
					<div className="flex flex-row justify-start items-center gap-3">
						<div>
							<Image src="/images/box.png" alt="box" width={50} height={50} />
						</div>
						<div>
							<h2>June&apos;s payroll</h2>
							<p>Approved and paid Jun 3, 2024</p>
						</div>
					</div>
					<div>
						<Link href="#">
			...
			${index === arr.length - 1 ? "rounded-r-lg lastRound" : ""}`}
				...
				<div className="p-3 flex flex-row justify-start items-center gap-3 w-full ">
					...
					/>
					<Button
						className="border-[#E8E8E8] border-[1px] bg-primary-1 text-white font-inter"
						onClick={bulkDeleteStaff}>
						<IconCircleCheckFilled /> Approve and Pay
					</Button>
				</div>
			</div>
