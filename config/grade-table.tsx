...
export function GradeDataTable<TData, TValue>({
	columns,
	data,
	...
	return (
		<div className="rounded-lg border-[1px] py-0">
			<Modal
				...
				<div className="bg-white p-6 rounded-lg transition-transform ease-in-out form w-[500px]">
					<div className="flex flex-col gap-4">
						<div>
							<p className="text-sm text-gray-600 mb-1">New grade level</p>
							<Input
								type="text"
						...
						<div className="space-y-3">
							<p className="text-sm text-gray-600">Salary heads</p>
							<div className="grid grid-cols-2 gap-4 mt-4">
								...
								<div className="flex flex-row justify-start items-center gap-5">
									<Checkbox />
									<p className="text-sm font-medium">Medicals</p>
								</div>
								<Input
									type="text"
									placeholder="Enter amount"
								...
								<div className="flex flex-row justify-start items-center gap-5">
									<Checkbox />
									<p className="text-sm font-medium">Accomodation</p>
								</div>
								<Input
									type="text"
									placeholder="Enter amount"
						...
						<div className="flex justify-end gap-3">
							...
							<Button
								...
								disabled={isLoading}>
								{isLoading ? "Saving..." : "Save grade level"}
							</Button>
						</div>
					</div>
				</div>
