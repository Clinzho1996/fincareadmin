...
export function StoreDataTable<TData, TValue>({
	...
	return (
		<div className="rounded-lg border-[1px] py-0">
			<Modal isOpen={isModalOpen} onClose={closeModal} title="Add Store">
				<div className="bg-white p-0 rounded-lg w-[600px] transition-transform ease-in-out form">
					<div className="mt-3  pt-2">
						<div className="flex flex-col gap-2">
							<p className="text-xs text-primary-6">Store Name</p>
							<Input
								type="text"
							...
							/>
							<p className="text-xs text-primary-6 mt-2">Store Address</p>
							<Input
								type="text"
							...
							/>
							<p className="text-xs text-primary-6 mt-2">Type</p>
							<Select>
								<SelectTrigger className="w-full">
									<SelectValue placeholder="Select Type" />
								</SelectTrigger>
								<SelectContent className="bg-white z-10 select text-gray-300">
									<SelectItem value="light">Laundromat</SelectItem>
									<SelectItem value="dark">Service Centre</SelectItem>
								</SelectContent>
							</Select>
							<p className="text-xs text-primary-6 mt-2">Position</p>
							<Select>
								<SelectTrigger className="w-full">
									<SelectValue placeholder="Select Position" />
								</SelectTrigger>
								<SelectContent className="bg-white z-10 select text-gray-300">
									<SelectItem value="light">HQ</SelectItem>
									<SelectItem value="dark">Branch</SelectItem>
								</SelectContent>
							</Select>
						</div>
			...
			<div
				className="bg-white flex flex-row border-b-[1px] border-[#E2E4E9] justify-between items-center p-3 w-full max-w-full"
				style={{
					borderTopLeftRadius: "0.5rem",
					borderTopRightRadius: "0.5rem",
				}}>
				<div className="flex flex-row justify-start items-center gap-3 w-full">
					<ActionCard title="Total Revenue" amount="1000000" />
					<ActionCard title="Total Expenses" amount="1000000" />
					<ActionCard title="Next Payout" amount="1000000" />
					<ActionCard title="Total Inventory" amount="1000000" />
					<ActionCard title="Total Stores" amount="33" />
				</div>
			</div>
