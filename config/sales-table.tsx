...
export function SalesDataTable<TData, TValue>({
	...
	return (
		<div className="rounded-lg border-[1px] py-0">
			<Modal isOpen={isModalOpen} onClose={closeModal} title="New Sales">
					...
					<div className="mt-3 border-t-[1px] border-[#E2E4E9] pt-2">
						<div className="flex flex-col gap-2">
							<div className="flex flex-col mt-1">
								...
								<Select>
									...
									<SelectContent className="bg-white z-10 select">
										<SelectItem value="light">Dev Clinton</SelectItem>
										<SelectItem value="dark">Promise Ogbuefi</SelectItem>
										<SelectItem value="system">Ayems Femi</SelectItem>
									</SelectContent>
								</Select>
							</div>
							...
							<div className="flex flex-col mt-2">
								...
								<Select>
									...
									<SelectContent className="bg-white z-10 select">
										<SelectItem value="light">Wallet</SelectItem>
										<SelectItem value="dark">Transfer</SelectItem>
										<SelectItem value="system">Bank Card</SelectItem>
									</SelectContent>
								</Select>
							</div>
							...
							<div className="flex flex-col mt-2">
								...
								<Select>
									...
									<SelectContent className="bg-white z-10 select">
										<SelectItem value="light">Cloth</SelectItem>
										<SelectItem value="dark">Food</SelectItem>
									</SelectContent>
								</Select>
							</div>
						...
						<div className="flex flex-row justify-end items-center gap-3 font-inter">
							...
							<Button
								...
								disabled={isLoading}>
								{isLoading ? "Adding Sales..." : "Add Sales"}
							</Button>
						</div>
					</div>
				</div>
			...
			<div className="p-3 flex flex-row justify-between border-b-[1px] border-[#E2E4E9] bg-white items-center gap-20 max-w-full">
				<div className="flex flex-row justify-start bg-white items-center rounded-lg mx-auto special-btn-farmer pr-2">
					{["View All", "Failed", "Pending", "Success"].map(
						(status, index, arr) => (
							<p
								key={status}
