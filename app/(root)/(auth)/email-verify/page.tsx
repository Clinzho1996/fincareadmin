		...
		<div className="w-full flex flex-col lg:flex-row justify-center items-center min-h-screen bg-primary-1">
			<div className="w-[80%] lg:w-[65%] flex flex-col gap-10 mx-auto my-auto">
				<div className="flex flex-col gap-1">
					...
					<p className="text-sm text-[#7d7c81] font-inter px-10 text-center w-[80%] lg:w-full mt-4">
							...
							<div className="mb-4 flex gap-4 justify-center">
								{[1, 2, 3, 4].map((num) => (
									<input
										...
										className="w-[70px] h-20 bg-[#00000029] text-white text-lg text-center rounded-lg p-2 border border-[#0000000D] placeholder:text-[#525254] focus:outline-none focus:border-[#C3FF9D] mt-1 shadow-inner"
									/>
								))}
							</div>
						</div>
